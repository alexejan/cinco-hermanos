...
df = pd.read_csv('C:\Grupparbete\Dataset\KLARA DATASET\CSV\medarbetarengagemangledarskap.csv', sep = ';')
...
layout = go.Layout(
    title='Siffrorna visar andelen medarbetare som tycker ledarna är engagerade',
)
