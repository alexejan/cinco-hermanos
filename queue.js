var queue = [
  {
      "tel": "Rimlig väntetid till vård- eller hälsocentral",
      "Enhetsnamn": "Blekinge",
      "År": "2017",
      "Resultat": "65.8%"
  },
...
//Kommentarer från .netcost2017 gäller även för denna fil.
let queue17 = filter17(queue);
let countyQue17 = countyNames(queue17);
let resultQue17 = countyResults(queue17);

let queue18 = filter18(queue);
let countyQue18 = countyNames(queue18);
let resultQue18 = countyResults(queue18);
...
var trace1 = {
  ...
  Plotly.newPlot('queue', data, layout, {showSendToCloud:true});